...
import {ZyraProxy} from "./ZyraProxy.sol";
...
contract AccountFactory is Ownable {
    ...
    // Account authorized to deploy Zyra accounts
    address private _deployer;

    /**
     * @notice Event emmited when a new Zyra account is created
     * @param accountAddress Address of the newly created Zyra account
     */
    event NewZyraAccount(address indexed accountAddress);
    ...
    function deployAccount(
        ...
        IZyraRegistry(_REGISTRY).register(accountAddress);

        emit NewZyraAccount(accountAddress);
    }

    /**
     * @notice Changes the account authorized to deploy Zyra accounts
     * @param newDeployer address - Address of the new account authorized to deploy Zyra accounts
     */
