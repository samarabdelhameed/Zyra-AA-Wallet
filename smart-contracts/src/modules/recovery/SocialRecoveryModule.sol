 ...
 * @notice Recovers the account using signatures from friends or family members (Zyra architecture)
 */
contract SocialRecoveryModule is BaseRecovery {
     ...
     * @param minTimelock uint128   - minimum timelock for recovery configs
